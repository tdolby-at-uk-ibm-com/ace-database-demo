...
public class JDBCTest_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
	        ...
	        stmt = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,
	                                    ResultSet.CONCUR_READ_ONLY);
	        ResultSet rs = stmt.executeQuery("SELECT name from Tea where id='0'");
	        ...
	        jsonData.createElementAsFirstChild(MbElement.TYPE_NAME_VALUE, "success", "JDBC");
